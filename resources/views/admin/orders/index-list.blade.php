            ...
            <div class="form-group col-xs-12 mb-2">
                ...
                <div class="form-group col-xs-6 ">
                    ...
                    <select id="user_name" name="pm" class="form-control">
                        ...
                        <option value="card" @if(Request::get('pm')=='card') selected  @endif  >Credit Card</option>
                    </select>
                </div>
            </div>
...
$('.orderlist').on('click',function(){ 
    ...
    $.ajax({
        ...
        success: function(result){
            ...
            $('.tot_amt').html("<span>: </span> {{Setting::get('currency')}}"+result.Order.invoimaps_addressce.net);
