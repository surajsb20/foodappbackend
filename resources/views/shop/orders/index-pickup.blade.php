                ...
                <form>
                    ...
                    <div class="form-group col-xs-12 ">
                        <div class="form-group col-xs-6 ">
                            ...
                            <input type="text" id="date" required readonly name="start_date"
                                   value="{{Request::get('start_date')}}" class="form-control datepicker"/>
                        </div>
                        <div class="form-group col-xs-6 ">
                            <label>End Date</label>
                            <input type="text" id="date" required readonly name="end_date"
                                   value="{{Request::get('end_date')}}" class="form-control datepicker"/>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-bordered file-export">
                    ...
                    @forelse($Orders as $Index => $Order)
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-darken-3 tab-order orderlist"
            ...
            <div class="card-block">
                ...
                @if(count($Orders)>0)
                    ...
                    <div class="row m-0">
                        ...
                        <dd class="col-sm-9 order-txt "><span>: {{currencydecimal($total_delivery_commision)}}</span>
                        </dd>
                    </div>
                    <div class="row m-0">
                        <dt class="col-sm-3 order-txt p-0">Total Commision</dt>
                        <dd class="col-sm-9 order-txt ">
                            <span>: {{currencydecimal($total_food_commision+$total_delivery_commision)}}</span></dd>
                    </div>
                @endif
            </div>
        </div>
...
@section('scripts')
    <script type="text/javascript"
            src="{{ asset('assets/admin/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js') }}"></script>
