                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form id="resource-delete" action="{{ route('shop.users.destroy', $User->id)}}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                    </form>
                                </td>
                        ...
                        <div class="col-lg-6 col-xs-12">
                            <div class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item b-l-0 b-r-0">Price : {{ $Item->product->prices ? $Item->product->prices[0]->price : 0 }}</li>
                                </ul>
